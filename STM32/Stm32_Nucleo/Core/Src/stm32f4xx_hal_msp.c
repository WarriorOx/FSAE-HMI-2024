  ...
  /* USER CODE END ADC3_MspInit 0 */
    ...
    */
    GPIO_InitStruct.Pin = ADC8_Pin|ADC6_Pin|ADC5_Pin|ADC15_Pin
                          |ADC14_Pin|ADC10_Pin|ADC9_Pin|ADC7_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB1     ------> ADC2_IN9
    */
    HAL_GPIO_DeInit(GPIOA, ADC2_Pin|ADC3_Pin);

    HAL_GPIO_DeInit(GPIOC, ADC4_Pin|LV_BAT_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PA1     ------> ADC3_IN1
    */
    HAL_GPIO_DeInit(GPIOF, ADC8_Pin|ADC6_Pin|ADC5_Pin|ADC15_Pin
                          |ADC14_Pin|ADC10_Pin|ADC9_Pin|ADC7_Pin);

    HAL_GPIO_DeInit(ADC11_GPIO_Port, ADC11_Pin);

    HAL_GPIO_DeInit(GPIOA, ADC13_Pin|ADC12_Pin);
